    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.CharField(blank=True, choices=[('sale', 'Sale'), ('new', 'New'), ('featured', 'Featured'), ('cheap', 'Cheap'), ('luxury', 'Luxury'), ('popular', 'Popular')], default='', max_length=500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('icon', models.CharField(blank=True, choices=[('bed', 'Bed'), ('bath', 'Bath'), ('wifi', 'WiFi'), ('tv', 'TV'), ('fan', 'Fan'), ('user-cog', 'Laundry'), ('utensils', 'Dinner')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate', models.CharField(blank=True, choices=[(1, 'One'), (2, 'Two'), (3, 'Three'), (4, 'Four'), (5, 'Five')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('view', models.CharField(blank=True, default='', max_length=500)),
